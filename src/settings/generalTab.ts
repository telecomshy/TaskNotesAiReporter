		...
		new Setting(container)
			...
			.addToggle((toggle) =>
				toggle
					...
					.onChange((value) => {
						void ctx.plugin.appSettings.toggleDateField(option.field, value);
					})
			);
	}
	...
	new Setting(container)
		...
		.addToggle((toggle) =>
			toggle
				...
				.onChange((value) => {
					void ctx.plugin.appSettings.setWeekStartsOnMonday(value);
				})
		);
	...
	new Setting(container)
		...
		.addText((text) =>
			text
				...
				.onChange((value) => {
					void ctx.plugin.appSettings.setReportLanguage(value);
				})
		);
	...
	new Setting(container)
		...
		.addDropdown((dropdown) =>
			dropdown
				...
				.onChange((value) => {
					void ctx.plugin.appSettings.setUiLanguage(value);
